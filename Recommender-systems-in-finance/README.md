...
ФАЙЛ PDF нужно скачать, в предпросмотре не открывается
...
Сравнено **11 моделей** нескольких классов:

| Класс | Модели |
|---|---|
| Коллаборативная фильтрация | User-kNN, Item-kNN | 
| Матричная фаткоризация | SVD, SVD++, NMF, ALS-WMF |
| Метод оптимизации | BPR |
| Нейросетевой подход | NCF |
